    ...
    <div class="fx-header-2-container">
        <div class="fx-header-2-wrap">
            ...
            <div class="fx-header-2-logo-box">
                <a href="https://makes360.org/gsainds" aria-label="name" class="fx-header-2-main-logo">
            ...
            <div class="fx-header-2-right">
                ...
                <div class="fx-header-2-top">
                    ...
                    <div class="fx-social-icon">
                        ...
                        <a href="https://www.linkedin.com/company/gsaindustriesindiaprivatelimited/"
                            class="fx-social-icon-btn" aria-label="name">
                ...
                <div class="fx-header-2-main">
                    ...
                    <div class="fx-header-2-action-link d-flex align-items-center justify-content-end">
                        ...
                        <!-- pr-btn -->
                        <a href="#" aria-label="name" class="fx-pr-btn-1 has-hover-border">
...
<div class="txa-offcanvas-box  offcanvas_box_active">
    ...
    <div class="txa-offcanvas-box-container lenis lenis-smooth">
        ...
        <div class="txa-offcanvas-services-wrap d-lg-block d-none">
            <h5 class="txa-offcanvas-services-title fx-heading-1 fx-font-400">our facilities:</h5>
